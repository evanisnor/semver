        ...
        fun validPreReleaseSemanticVersionStrings(): List<Arguments> =
            listOf(
                ...
                arguments(
                    "1.1.1-RC.1",
                    SemanticVersion(
                        1, 1, 1, preReleaseVersion = PreReleaseVersion(identifier = "RC", version = 1)
                    )
                ),
                arguments(
                    "999.99.99-RC.99",
                    SemanticVersion(
                        999, 99, 99, preReleaseVersion = PreReleaseVersion(identifier = "RC", version = 99)
                    )
                ),
            )
            ...
            listOf(
                arguments(
                    ...
                    SemanticVersion(0, 1, 0)
                        .asPreReleaseVersion(PreReleaseVersion(identifier = "RC", version = 1))
                        .withBuildMetadata("abcdefgh0000000")
                ),
                arguments(
                    "0.0.0-RC.99+abcdefgh0000000",
                    SemanticVersion(0, 0, 0)
                        .asPreReleaseVersion(PreReleaseVersion(identifier = "RC", version = 99))
                        .withBuildMetadata("abcdefgh0000000")
                ),
                arguments(
